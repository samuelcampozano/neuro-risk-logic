...
class AssessmentRequest(BaseModel):
    ...
    consanguinity: bool = Field(
        ..., 
        description="Are the subject's parents blood-related?"
    )
    family_neuro_history: bool = Field(
        ..., 
        description="Family history of neurological disorders?"
    )
    ...
    psychiatric_diagnosis: bool = Field(
        ..., 
        description="Diagnosed with any psychiatric disorder?"
    )
    substance_use: bool = Field(
        ..., 
        description="Does the subject consume psychoactive substances regularly?"
    )
    suicide_ideation: bool = Field(
        ..., 
        description="History of suicide attempts or ideation?"
    )
    ...
    extreme_poverty: bool = Field(
        ..., 
        description="Does the subject live in extreme poverty?"
    )
    ...
    breastfed_infancy: bool = Field(
        ..., 
        description="Was the subject breastfed during infancy?"
    )
    ...
    clinician_id: Optional[str] = Field(
        None, 
        description="ID of clinician requesting assessment"
    )
    ...
    consent_given: bool = Field(
        ..., 
        description="Subject consent for data use"
    )
