...
class RiskCalculator:
    ...
    def calculate_risk_factors(
        ...
        if feature_contributions:
            risk_factors.sort(
                key=lambda x: abs(feature_contributions.get(x, 0)), 
                reverse=True
            )
    ...
    def generate_recommendations(
        ...
        if risk_level == "high":
            recommendations.append("Immediate comprehensive neurodevelopmental evaluation recommended")
            recommendations.append("Priority referral to specialist care")
        elif risk_level == "moderate":
            recommendations.append("Neurodevelopmental screening recommended within 3 months")
            recommendations.append("Regular monitoring of symptoms")
        else:
            recommendations.append("Continue routine developmental monitoring")
        ...
        if assessment_data.get('suicide_ideation'):
            recommendations.append("URGENT: Immediate psychiatric intervention required")
            recommendations.append("Implement suicide prevention protocol")
    ...
    def interpret_risk_level(
        ...
        interpretations = {
            "low": {
                "summary": "Low risk of neurodevelopmental disorders",
            ...
            "moderate": {
                "summary": "Moderate risk of neurodevelopmental disorders",
            ...
            "high": {
                "summary": "High risk of neurodevelopmental disorders",
                "description": "Multiple significant risk factors present. Immediate evaluation and intervention recommended.",
        ...
        if confidence_score < 0.7:
            interpretation["confidence_note"] = "Model confidence is moderate. Consider additional assessment."
        elif confidence_score < 0.5:
            interpretation["confidence_note"] = "Model confidence is low. Results should be interpreted with caution."
        else:
