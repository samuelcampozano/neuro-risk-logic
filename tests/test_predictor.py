...
class TestPredictorUtilities:
    ...
    def test_feature_processing(self):
        ...
        expected_features = [
            ...
            "substance_use", "suicide_ideation", "psychotropic_medication",
            "birth_complications", "extreme_poverty", "education_access_issues",
            "healthcare_access", "disability_diagnosis", "social_support_level",
            "breastfed_infancy", "violence_exposure"
        ]
